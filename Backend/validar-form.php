<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($flag==true){
            $fecha = date("d-m-Y");
            $newUser = mysqli_query($conn, "INSERT INTO usuarios(tipo,nombre,correo,contraseña,descp,foto,facebook,twitter,instagram,fechaUnion) VALUES ('$tipo','$nombre','$correo','$passw','$descp','$foto','$facebook','$twitter','$instagram','$fecha')");
