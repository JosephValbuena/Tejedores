<?php
    ...
    if(!empty($_POST['email']) && !empty($_POST['passw']) && filter_var($_POST['email'],FILTER_VALIDATE_EMAIL)){
        ...
        if(count($results)>0 && password_verify($_POST['passw'], $results['contraseña'])){
            ...
            $message = 'Lo sentimos, tu correo o contraseña están incorrectos. Revisa';
        }
    }
