...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/estilosSubida.css">
    <!--Bootstrap-->
...
<body>
    ...
    <div class="principal mt-5">
        ...
        <form action="../Backend/subir.php" id="subirTejido" method="POST" enctype="multipart/form-data" class="formSubir">
            <div class="mb-3">
            ...
            <div  id="errorSubirTejido" class ="mb-3 mt-2">
    ...
    <script src="../assets/js/comprobarSubir.js"></script>
</body>
