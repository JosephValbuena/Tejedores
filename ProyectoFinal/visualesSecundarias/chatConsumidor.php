...
<body class="body">
    <div class="row">
        ...
        <div class="col-5 ">
            ...
            <div class="chateo">
                <div class="chateoHeader">
                    <img src="../Backend/imagenes/usuarios/<?=$obtFetch['foto']?>"
                        alt="">
                    <p><?=$obtFetch['nombre']?></p>
                </div>
                <hr>
                ...
                <?php
                    if(isset($_POST['enviar'])){
                        ...
                        if($mensaje == ""){
                            ...
                            echo '<script>window.location="../visualesSecundarias/chatTejedor.php?usuario='.$para.'"</script>';
                        }else{
                            $de = $_SESSION['user_id'];
                            $para = mysqli_real_escape_string($conn,$_GET['usuario']);
        ...
        <div class="col-2 barraDerecha">
            ...
            ?>
            <a href="../visualesSecundarias/chatConsumidor.php?usuario=<?php echo $obtInfoFetch['id']; ?>">
                <div class="burbuja">
                    <img src="../Backend/imagenes/usuarios/<?=$obtInfoFetch['foto']?>"
                        alt="User picture">
