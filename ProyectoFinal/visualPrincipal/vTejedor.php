            ...
            <div class="card text-center mt-3 bg-dark publicacion">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <button class="btn btn-outline-primary btn-sm editar"
                                id="publi-<?=$row['idPubli']?>">editar</button>
                            <?php } ?>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        ...
                        <?php
                            $idChatUsu = mysqli_query($conn,"SELECT * FROM tejido where idPubli = '".$row['idPubli']."'");
                        ...
                        <?php } else { ?>
                        <a href="../visualesSecundarias/chatTejedor.php?usuario=<?=$idUsuFetch['id_user']?>"
                    ...
                    <div class="card-footer text-muted mt-2 text-start">
                        ...
                        ?>
                        <div class="" id="nuevocomentario-<?php echo $row['idPubli'];?>">
                            <div class="box-comment">
                                <div class="comment-information">
                                    <img src="../Backend/imagenes/usuarios/<?php echo $usec['foto'];?>"
                                        alt="" class="user-pic img-responsive rounded">
                                    <span class="username">
