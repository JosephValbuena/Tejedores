...
<body class="body">
            ...
            <div class="card text-center mt-3 bg-dark publicacion">
                <div class="card-header text-start">
                    <div class="row ">
                        ...
                        <div class="col-8 text-end">
                            <button class="btn btn-outline-primary btn-sm editar"
                                id="publi-<?=$row['idPubli']?>">Editar</i></button>
                            <button class="btn btn-outline-danger btn-sm ocultar"
                                id="publi-<?=$row['idPubli']?>">Ocultar</i></button>
                            <a href="../visualesSecundarias/perfilTejedor.php?usuario=<?php echo $row['id_user'];?>"
                ...
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        ...
                        <?php if($idUsuFetch['id_user'] == $_SESSION['user_id']){  ?>
                        <form action="/ProyectoFinal/Backend/comprado.php" method="POST">
                            <input type="hidden" name="idComprado" value="<?php echo $row['idPubli']; ?>">
                            <input type="submit" name="comprado" class="btn btn-primary"
                                value="Tejido Comprado"></input>
                        </form>
                        <?php } else { ?>
                        <a href="../visualesSecundarias/chatAdmin.php?usuario=<?=$idUsuFetch['id_user']?>"
                        ...
                        <ul class="barraLike text-start ">
                            <li>
                                ...
                                <div class="btn btn-outline-primary btn-sm like" id="<?php echo $row['idPubli'];?>"><i
                                        class="fas fa-thumbs-up">Me gusta</i></div><span
                                    id="likes_<?php echo $row['idPubli'];?>">(<?php echo $row['likes'];?>)</span>
                    ...
                    <div class="card-footer text-muted mt-2 text-start">
                        ...
                        <br>
                        <center>
                            <a href='../visualesSecundarias/verComentarios.php?publicacion=<?=$row['idPubli']?>'
                                class='btnVerComentarios'>Ver todos los comentarios</a>
                        </center>
                        <?php  } ?>
                        <div class="formulario-coment">
                            <form action="" method="post" id="record-<?php echo $row['idPubli'];?>">
                                <label class="labelComentario" for="comentar">Comentar
                                    <input class="form-control enviar-btn" type="text" name="comentario"
                                        id="comentario-<?php echo $row['idPubli'];?>"
                                        placeholder="Escribe un comentario">
                                </label>
                                <input type="hidden" name="usuario" id="usuario" value="<?php echo $id;?>">
                                <input type="hidden" name="publicacion" id="publicacion"
                                    value="<?php echo $row['idPubli'];?>">
    ...
    <div class="overlay">
        <div class="popup">
            ...
            <h3>¿Está seguro de que desea ocultar la publicación?</h3>
            <form action="../Backend/ocultar.php" method="POST">
                <input type="hidden" name="idPublic" id="paraOcultar">
                <input type="submit" class="btn btn-outline-danger seguro" value="Ocultar"></input>
            </form>
        </div>
    </div>
    ...
    <div class="overlay2">
        <div class="popup2">
            ...
            <h3>Edite esta publicación</h3>
            <form action="../Backend/editarPubli.php" method="POST">
                <div class="contenedor-inputs">
                    <input type="hidden" name="idPublicacionN" id="idPublicacionN" class="idPublicacionN">
                    <label for="tituloN">Titulo Nuevo</label>
                    <input type="text" name="tituloN" id="tituloN" class="tituloN">
                    <label for="descpN">descripción Nueva</label>
                    <input type="text" name="descpN" id="descpN" class="descpN">
                    <label for="precioN">Precio Nuevo</label>
                    <input type="text" name="precioN" id="precioN" class="precioN">
                </div>
                <input class="btn btn-outline-primary btn-submit" type="submit" value="Editar">
            </form>
        </div>
    </div>
