                        ...
                        <div class="sidebar-menu">
                            <ul>
                                ...
                                <li class="sidebar-dropdown">
                                    <a href="../visualesSecundarias/perfilConsumidor.php?usuario=<?php echo $_SESSION['user_id'];?>">
                                ...
                                <li class="sidebar-dropdown">
                                    <a href="../visualesSecundarias/chatConsumidor.php?usuario=<?php echo $_SESSION['user_id'];?>">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        ...
                        ?>
                            ...
                            <a href="/ProyectoFinal/visualesSecundarias/chatTejedor.php?usuario=<?=$idUsuFetch['id_user']?>" class="btn btn-warning">Ofertar</a>
